...
/** Prévient le client qu'un email de suivi colis arrivera sous 24 h. */
export async function sendShippingPendingEmail(input: {
  ...
  const body = `
    ...
    ${emailParagraph("Dans les <strong>prochaines 24 heures</strong>, vous recevrez un email avec le <strong>numéro de suivi</strong> dès que votre colis sera remis au transporteur.")}
  ...
  const text = [
    ...
    "",
    "Dans les prochaines 24 heures, vous recevrez un email avec le numéro de suivi dès l'expédition de votre colis.",
    "",
