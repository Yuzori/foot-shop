...
/** Prévient le client que le lien Chronopost arrivera sous 2 à 7 jours. */
export async function sendShippingPendingEmail(input: {
  ...
  const body = `
    ...
    ${emailParagraph("Comptez <strong>2 à 7 jours</strong> pour recevoir par email le <strong>lien de suivi Chronopost</strong> dès que votre colis sera remis au transporteur.")}
  ...
  const text = [
    ...
    "",
    "Comptez 2 à 7 jours pour recevoir par email le lien de suivi Chronopost dès l'expédition de votre colis.",
    "",
